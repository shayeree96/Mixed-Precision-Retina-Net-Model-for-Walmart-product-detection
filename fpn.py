...
class FPNS16(nn.Module):
    def __init__(self, block, num_blocks):
        super(FPNS16, self).__init__()
        self.in_planes = 64
...
class FPNO6(nn.Module):
    def __init__(self, block, num_blocks):
        super(FPNO6, self).__init__()
        self.in_planes = 64
...
def Res50S16():
    return FPNS16(Bottleneck, [3, 4, 6, 3])

def FPN50O6():
    return FPNO6(Bottleneck, [3, 4, 6, 3])
